...
const NotFound = () => {
  ...
  return (
    <div className="pt-20 md:pt-32 pb-20 min-h-[80vh] flex items-center justify-center text-[#f1f5f9]">
      <div className="container mx-auto px-6 text-center">
        ...
        <h2 className="text-4xl md:text-6xl font-bn font-black mb-6 italic text-white">
          পাতাটি <span className="italic" style={{ color: '#22C55E' }}>খুঁজে পাওয়া যায়নি!</span>
        </h2>
