    ...
    <div className="pt-24 pb-40 min-h-screen text-slate-800">
      <div className="max-w-4xl mx-auto px-6">
        <h1 className="text-4xl md:text-6xl font-bn font-black mb-10 text-[#0F172A] italic">
          কুকিজ <span style={{ color: '#F97316' }}>নীতি</span>
        </h1>
        
        <div className="space-y-12 font-bn text-[17px] leading-relaxed text-slate-600">
          <section>
            <h2 className="text-2xl text-[#0F172A] font-black mb-4">১. কুকিজ কী?</h2>
          ...
          <section>
            <h2 className="text-2xl text-[#0F172A] font-black mb-4">২. আমরা কেন কুকিজ ব্যবহার করি?</h2>
          ...
          <section>
            <h2 className="text-2xl text-[#0F172A] font-black mb-4">৩. থার্ড-পার্টি কুকিজ ও অ্যাডসেন্স</h2>
          ...
          <section>
            <h2 className="text-2xl text-[#0F172A] font-black mb-4">৪. নিয়ন্ত্রণ</h2>
          ...
          <p className="pt-10 border-t border-[var(--bg-border)] text-sm italic text-slate-500">সর্বশেষ আপডেট: ২রা এপ্রিল, ২০২৬</p>
        </div>
      </div>
    </div>
  );
