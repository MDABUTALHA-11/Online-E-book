  ...
  return (
    <div className="pt-24 pb-40 min-h-screen text-[#f1f5f9]">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="space-y-12 font-bn text-[17px] leading-relaxed text-slate-400 text-justify">
          <section>
          ...
          <section>
            <h2 className="text-2xl text-white font-black mb-4">১. তথ্য সংগ্রহ ও ব্যবহার</h2>
          ...
          <section>
            <h2 className="text-2xl text-white font-black mb-4">২. গুগল অ্যাডসেন্স ও কুকিজ (Google AdSense & Cookies)</h2>
          ...
          <section>
            <h2 className="text-2xl text-white font-black mb-4">৩. থার্ড পার্টি প্রাইভেসি পলিসি</h2>
          ...
          <section>
            <h2 className="text-2xl text-white font-black mb-4">৪. শিশুদের তথ্য সুরক্ষা (Children's Information)</h2>
            <p>ইন্টারনেট ব্যবহারের সময় শিশুদের সুরক্ষা নিশ্চিত করা আমাদের অন্যতম লক্ষ্য। আমরা ১৩ বছরের কম বয়সী শিশুদের থেকে জেনেশুনে কোনো ব্যক্তিগত তথ্য সংগ্রহ করি না। যদি আপনি মনে করেন আপনার সন্তান আমাদের সাইটে এমন কোনো তথ্য দিয়েছে, তবে অনুগ্রহ করে আমাদের সাথে যোগাযোগ করুন। we will remove that info immediately.</p>
          </section>

          <section>
            <h2 className="text-2xl text-white font-black mb-4">৫. নীতিমালায় পরিবর্তন</h2>
            <p>আমরা যেকোনো সময়ে এই গোপনীয়তা নীতিমালায় পরিবর্তন আনতে পারি। বড় কোনো পরিবর্তন করা হলে আমরা সাইটের নোটিশ বোর্ডে বা প্রোফাইল নোটিফিকেশনে জানাবো।</p>
          </section>

          <section>
            <h2 className="text-2xl text-white font-black mb-4">৬. যোগাযোগ</h2>
            <p>আমাদের গোপনীয়তা নীতি নিয়ে কোনো প্রশ্ন থাকলে সরাসরি আমাদের ইমেইল করতে পারেন।</p>
          </section>

          <p className="pt-10 border-t border-white/10 text-sm italic">সর্বশেষ আপডেট: ১৭ই এপ্রিল, ২০২৬</p>
        </div>
      </div>
    </div>
  );
