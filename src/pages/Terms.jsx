    ...
    <div className="pt-24 pb-40 min-h-screen text-[#f1f5f9]">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="space-y-12 font-bn text-[17px] leading-relaxed text-slate-400 text-justify">
          ...
          <section>
            <h2 className="text-2xl text-white font-black mb-4">২. মেধা সম্পদ ও কপিরাইট (Intellectual Property)</h2>
            <p>এই ওয়েবসাইটে থাকা সকল হ্যান্ডনোট, ডিজাইন, লোগো এবং টেক্সট শাইফলির নিজস্ব সম্পদ। অনুমতি ছাড়া কোনো কন্টেন্ট বাণিজ্যিক উদ্দেশ্যে অন্য কোথাও কপি, রি-আপলোড বা বিক্রি করা কঠোরভাবে নিষিদ্ধ। শুধুমাত্র ব্যক্তিগত পড়াশোনার জন্য আপনি আমাদের রিসোর্সগুলো ব্যবহার করতে পারেন।</p>
          </section>

          <section>
            <h2 className="text-2xl text-white font-black mb-4">৩. কুইজ ও ফেয়ার প্লে</h2>
          ...
          <section>
            <h2 className="text-2xl text-white font-black mb-4">৪. দায়বদ্ধতা (Disclaimer)</h2>
          ...
          <section>
            <h2 className="text-2xl text-white font-black mb-4">৫. অ্যাকাউন্টের নিরাপত্তা</h2>
